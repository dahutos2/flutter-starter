...
### Windowsでのローカル環境でレイヤーの作成手順

#### 1. 必要なパッケージをインストールし、レイヤーを作成
...
コマンドプロンプトまたはPowerShellを開き、以下のコマンドを実行してレイヤーを作成します。
...
### AWS Management Consoleでの操作手順

#### 2. AWS Management Consoleでレイヤーを作成

...
class CameraIsolate {
  ...
  static Future<Uint8List?> convertAndProcessCameraImage(
    ...
    if (cameraImage.format.group == ImageFormatGroup.yuv420) {
      ...
      img = await compute(_yuv420ConvertAndProcessCameraImage, cameraImageData);
      ...
      img =
          await compute(_bgra8888ConvertAndProcessCameraImage, cameraImageData);
    }
    return img == null ? null : _convertToBytes(img);
  }

  static Future<Uint8List> _convertToBytes(imglib.Image image) async {
    return await compute(
        (image) => Uint8List.fromList(imglib.encodePng(image)), image);
  }

  static Future<imglib.Image> _yuv420ConvertAndProcessCameraImage(
  ...
  static Future<imglib.Image> _bgra8888ConvertAndProcessCameraImage(
      Map<String, dynamic> cameraImageData) async {
